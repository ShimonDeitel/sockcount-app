...
final class SockcountUITests: XCTestCase {
    ...
    func testFreeLimitTriggersPaywall() throws {
        ...
        XCTAssertTrue(app.buttons["unlockProButton"].waitForExistence(timeout: 5) || app.staticTexts["Sockcount Pro"].waitForExistence(timeout: 5))
    }
