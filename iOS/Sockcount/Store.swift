...
final class Store: ObservableObject {
    ...
    /// Free tier allows this many total break entries before the paywall appears.
    ...
    init() {
        ...
        entriesURL = support.appendingPathComponent("sockcount_entries.json")
        settingsURL = support.appendingPathComponent("sockcount_settings.json")
        load()
        if entries.isEmpty {
            seed()
        }
